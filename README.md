# Vagrant box Debian 13 LAMP

Make a Vagrant box with Debian 13 LAMP stack, plus configure it for development.

- Host: Linux or Mac.
- Guest: Debian 13, Apache 2.4, MariaDB 11.8, PHP 8.4, Python 3.13, Ruby 3.3, NPM 9.x, Node.js 20.x, Git 2.x.
...
```bash
mkdir -p ~/VM && cd $_
git clone --depth=1 https://github.com/stemar/vagrant-debian-13.git debian-13
cd ~/VM/debian-13
...
- 64bit Debian 13 virtual machine with virtual 64GB HDD, 3GB RAM and updated LAMP stack from [Bento](https://app.vagrantup.com/bento/boxes/debian-13).
